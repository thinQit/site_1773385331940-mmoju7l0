...
export default function HeroSpotlight({
  headline = "Grow Revenue with Smarter Automation",
  subheadline = "Launch campaigns faster, convert more leads, and scale with confidence using one modern growth platform.",
